...
public class MoreWindows extends PopupWindow implements View.OnClickListener {
    private String TAG = MoreWindows.class.getSimpleName();
    Activity mContext;
    private int mWidth;
    private int mHeight;
    ...
    public MoreWindows(Activity context) {
        mContext = context;
    }
